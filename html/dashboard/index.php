...
<!--Title Page and Links-->
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <title>TaskTool | Task Management Tool</title>
  ...
  <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
      <a href="../dashboard/index.html" class="navbar-brand">
        <h4 class="logo-title">TaskTool</h4>
      </a>
            ...
            <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
              ...
              <li class="nav-item">
                <a class="nav-link " href="../dashboard/app/user-add.html">
                  ...
                  <span class="item-name">Add Members</span>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link " href="../dashboard/app/user-list.html">
                  ...
                  <span class="item-name">Members List</span>
                </a>
              </li>
            </ul>
          </li>
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <i class="icon">
              ...
              <span class="item-name">Project (Kaiju)</span>
            </a>
          </li>
        </ul>
        </li>
                      ...
                      <a href="#" class="iq-sub-card">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-3 w-100">
                            <h6 class="mb-0 ">Project (Kaiju)</h6>
                            <div class="d-flex justify-content-between align-items-center">
                              <p class="mb-0">Sean Wong made changes</p>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="p-0 sub-drop dropdown-menu dropdown-menu-end" aria-labelledby="mail-drop">
                  <div class="m-0 shadow-none card">
                    <div class="py-3 card-header d-flex justify-content-between bg-primary">
                      <div class="header-title">
                        <h5 class="mb-0 text-white">Recent Message</h5>
                      </div>
                    </div>
                    ...
                    <div class="p-0 card-body ">
                      ...
                      <a href="#" class="iq-sub-card">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-3">
                            <h6 class="mb-0 ">Wong Jung Teng</h6>
                      ...
                      <a href="#" class="iq-sub-card">
                        <div class="d-flex align-items-center">
                          <div class="">
                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary" src="../assets/images/shapes/02.png"
                              alt="">
                          </div>
                          <div class="ms-3">
                            <h6 class="mb-0 ">Gan Wei Chen</h6>
              ...
              <li class="nav-item dropdown">
                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                  ...
                  <div class="caption ms-3 d-none d-md-block ">
                    <h6 class="mb-0 caption-title">Lee Jia Juinn</h6>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div>
                  <h1>Hello Lee Jia Juinn!</h1>
                  <p>Quicky Access Your Recent Boards, the Community, and Notifications!</p>
                </div>
            ...
            <div class="col-md-12">
              <div class="card" data-aos="fade-up" data-aos-delay="800">
                <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                  <div class="header-title">
                    <h4 class="card-title">Your Boards</h4>
                  </div>
                </div>
                <div class="p-0 card-body">
                    ...
                    <table id="basic-table" class="table mb-0 table-striped" role="grid">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <a href="dashboard.html"><img class="rounded bg-soft-primary img-fluid avatar-40 me-3"
                                src="../assets/images/shapes/01.png" alt="profile"></a>
                              <a href="dashboard.html"><h6>Project (Kaiju)</h6></a>
                            </div>
                          </td>
                          <td>
                            <div class="iq-media-group iq-media-group-1">
                              <a href="#" class="iq-media-1">
                                <div class="icon iq-icon-box-3 rounded-pill">WC</div>
                              </a>
                              <a href="#" class="iq-media-1">
                                <div class="icon iq-icon-box-3 rounded-pill">SM</div>
                              </a>
                              <a href="#" class="iq-media-1">
                                <div class="icon iq-icon-box-3 rounded-pill">JT</div>
                              </a>
                            </div>
                          </td>
                          <td>08/07/2024</td>
            ...
            <div class="col-md-12 col-lg-12">
              <div class="overflow-hidden card" data-aos="fade-up" data-aos-delay="600">
                <div class="flex-wrap card-header d-flex justify-content-between">
                  <div class="header-title">
                    <h4 class="mb-2 card-title">Community</h4>
                  </div>
                  ...
                  <div class="card-body">
                    <ul class="list-inline m-0 p-0">
                      <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-warning rounded-pill"><img src="../assets/images/icons/05.png"
                            alt="story-img" class="rounded-pill avatar-40"></div>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-danger rounded-pill"><img src="../assets/images/icons/03.png"
                            alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                          <h6>Lim Zi Jie</h6>
                          <p class="mb-0">4 mutual friends</p>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-dark rounded-pill"><img src="../assets/images/icons/06.png"
                            alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                          <h6>Tan Yu Xuan</h6>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-primary rounded-pill"><img src="../assets/images/icons/07.png"
                            alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                          <h6>Jay Wong</h6>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-info rounded-pill"><img src="../assets/images/icons/04.png"
                            alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                          <h6>Kaviraj A/L Vijayanthiran</h6>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-warning rounded-pill"><img src="../assets/images/icons/02.png"
                            alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                          <h6>Gan Wei Chen</h6>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-success rounded-pill"><img src="../assets/images/icons/01.png"
                            alt="story-img" class="rounded-pill avatar-40"></div>
                        <div class="ms-3 flex-grow-1">
                          <h6>Aaditya Srivastava</h6>
              ...
              <div class="card" data-aos="fade-up" data-aos-delay="600">
                ...
                <div class="card-body">
                  <div class="mb-2  d-flex profile-media align-items-top">
                    ...
                    <div class="ms-4">
                      <h6 class="mb-1 ">Task Added, Project (Kaiju)</h6>
                      <span class="mb-0">30 JUN 8:10 PM</span>
                    </div>
                  </div>
                  <div class="mb-2  d-flex profile-media align-items-top">
                    <div class="mt-1 profile-dots-pills border-primary"></div>
                    <div class="ms-4">
                      <h6 class="mb-1 ">Task Deleted, Project (Kaiju)</h6>
                      <span class="mb-0">29 JUL 11:20 PM</span>
                    </div>
                  </div>
                  <div class="mb-2  d-flex profile-media align-items-top">
                    <div class="mt-1 profile-dots-pills border-primary"></div>
                    <div class="ms-4">
                      <h6 class="mb-1 ">Member Joined, Project (Kaiju)</h6>
                      <span class="mb-0">25 JUN 7:64 AM</span>
                    </div>
                  </div>
                  <div class="mb-2  d-flex profile-media align-items-top">
                    <div class="mt-1 profile-dots-pills border-primary"></div>
                    <div class="ms-4">
                      <h6 class="mb-1 ">Task Completed, Project (Kaiju)</h6>
                      <span class="mb-0">24 JUN 1:21 AM</span>
                    </div>
                  </div>
                </div>
              </div>
